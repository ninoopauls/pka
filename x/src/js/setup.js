...
function csvFileToJSON(content){
          ...
          Pallets.forEach( function (aPallet) {
                ...
                let LPN = aPallet["LPN"];
                let x = parseInt(aPallet["Coordinate X"], 10), y = parseInt(aPallet["Coordinate Y"], 10), z = parseInt(aPallet["Coordinate Z"], 10);
                let Length = parseInt(aPallet["Length"],10), Width = parseInt(aPallet["Width"],10), Height = parseInt(aPallet["Height"],10), Unit = aPallet["Unit"];

                console.log("csvFileToJSON, Coordinates : ", x, y, z);
                console.log("csvFileToJSON, Dimensions : ", Length, Width, Height);

                createPalleteBox(LPN, {x, y, z}, {Length, Width, Height, Unit}, 60, 40);
...
function createPalleteBox(LPN, aCoordinate, aDimension, wFloorLength, wFloorWidth)
{
    ...
    console.log(aDimension.Length, aDimension.Height, aDimension.Width)
...
function init() {
    ...
    /* warehouse.Pallets.forEach( function (pallet) {
        ...
        const {LPN, Coordinates, Dimensions, Weight, Available} = pallet;
        createPalleteBox(LPN, Coordinates, Dimensions, 60, 40)
    })  */
